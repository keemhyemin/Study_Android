...
public class GiftShopSubFragment extends Fragment {

    FragmentGiftShopSubBinding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentGiftShopSubBinding.inflate(inflater, container, false);
